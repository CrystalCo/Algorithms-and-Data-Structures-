...
//All Tasks are completed and they worked 100% ... 
// HW3 CSC402
...
public class HW3 {
	...
	public static void draw(MyRect rect, int level, Color c) {
        ...
        if (level % 2 == 0) {
            ...
            draw(left, level - 1, randomColorLight(c));  
            ...
            draw(right, level - 1, randomColorDark(c));
            ...
            draw(below, level - 1, randomColorLight(c)); 
            //  StdDraw.setPenColor(randomColorLight(c));
            // below.drawEllipse();
            // change above two lines to a recursive call 
            // TODO: draw(...);
            MyRect above = new MyRect(rect.xmin(), ymid, rect.xmax(), rect.ymax());
            draw(above, level - 1, randomColorDark(c));
            //StdDraw.setPenColor(randomColorDark(c));
            // above.drawEllipse();
            // change above two lines to a recursive call 
            // TODO: draw(..);
	...
	public static void main(String[] args) {
		testEquals();
		// TODO: In your submission the ABOVE LINE must be uncommented
